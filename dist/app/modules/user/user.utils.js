...
exports.generateAdminId = exports.findLastAdminId = exports.generateFacultyId = exports.findLastFacultyId = exports.generateStudentId = exports.findLastStudentId = exports.getLogDateAndTime = void 0;
/* eslint-disable no-undefined */
const users_1 = require("../../../enums/users");
const user_model_1 = require("./user.model");
const getLogDateAndTime = (dateString) => {
    const originalFormat = dateString;
    const modifiedFormat = originalFormat
        .replace('T', ' ')
        .replace('Z', '');
...
const findLastStudentId = () => __awaiter(void 0, void 0, void 0, function* () {
    const lastStudent = yield user_model_1.User.findOne({ role: users_1.ENUM_USER_ROLE.STUDENT }, { id: 1, _id: 0 })
        .sort({
        createdAt: -1,
    })
        .lean();
...
const findLastFacultyId = () => __awaiter(void 0, void 0, void 0, function* () {
    const lastFaculty = yield user_model_1.User.findOne({ role: users_1.ENUM_USER_ROLE.FACULTY }, { id: 1, _id: 0 })
        .sort({
        createdAt: -1,
    })
        .lean();
...
const findLastAdminId = () => __awaiter(void 0, void 0, void 0, function* () {
    const lastAdminId = yield user_model_1.User.findOne({ role: users_1.ENUM_USER_ROLE.ADMIN }, { id: 1, _id: 0 })
        .sort({
        createdAt: -1,
    })
        .lean();
